...
export function EmptyDemo2() {
  ...
  return (
    <Empty className="p-4 h-36.5 border rounded-lg shadow-sm hover:shadow-lg transition-shadow cursor-pointer bg-gray-100">
        <EmptyContent>
        <div className="flex gap-2">
          {isClient && (
          <Dialog>
        <DialogTrigger asChild>
          <Button variant="outline" className="p-4 h-36.5 border rounded-lg shadow-sm hover:shadow-lg transition-shadow cursor-pointer bg-gray-100 w-89 text-lg">Create New Budget</Button>
        </DialogTrigger>
